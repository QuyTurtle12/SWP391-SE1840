...
function ProductList() {
  ...
  return (
    <div className="">
      <StaffMenu />
      <div className="bg-tiffany py-36">
            ...
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-lg shadow-lg p-8">
                <div className="relative overflow-hidden">
                  <img className="object-cover w-full h-96" src={product.img} alt={product.name} />
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <button onClick={() => addToCart(product)} className="bg-gray-900 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800">
                    Add to Cart
                  </button>
                </div>
              </div>
