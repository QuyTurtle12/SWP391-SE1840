...
const AddStaff = () => {
  ...
  return (
    <div className="bg-white text-black min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <ManagerMenu />
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-sm font-medium leading-5">Full Name</label>
            ...
            <div>
              <label className="block text-sm font-medium leading-5">Gender</label>
              <select
                id="gender"
                value={gender}
                onChange={(e) => setGender(e.target.value)}
                className="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5"
                required
              >
            ...
            <div>
              <label className="block text-sm font-medium leading-5">Email Address</label>
              <div className="mt-1 rounded-md shadow-sm">
                <input
                  id="email"
                  name="email"
            ...
            <div>
              <label className="block text-sm font-medium leading-5">Password</label>
              <div className="mt-1 rounded-md shadow-sm">
                <input
                  id="password"
                  name="password"
            ...
            <div>
              <label className="block text-sm font-medium leading-5">Contact Information</label>
              <div className="mt-1 rounded-md shadow-sm">
                <input
                  id="contactInfo"
                  name="contactInfo"
            ...
            <div>
              <label className="block text-sm font-medium leading-5">Counter ID</label>
              <select
                id="counterID"
                value={counterID}
            ...
            <div>
              <button
                type="submit"
                className="block w-full py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-700"
              >
                Create Staff
              </button>
              <ToastContainer />
